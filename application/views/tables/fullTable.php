<div class="card mb-5">
    <div class="card-body row">
        <div class="col-sm-12 col-md-6">
            ...
            <p class="card-text">建立完整功能的 DataTables，TablesIgniterCI3 可以滿足你所需要的「串接HTML」、「搜索」、「排序」等常見功能。</p>
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="ex-con-2" role="tabpanel">
                    ...
                    <ol>
                        <li>
                            呼叫 setTable() 方法必須傳入 <a href="https://codeigniter.com/userguide3/database/query_builder.html" target="_blank">Query Builder</a> 物件，TablesIgniterCI3 倚賴這個物件所定義的資料庫查詢內容。這個物件通常會在 Model 宣告。並且，你必須在第二個引數中傳遞執行 query 的資料表名稱。
                        </li>
                        <li>
                ...
                <div class="tab-pane fade" id="ex-model-2" role="tabpanel" >
                    ...
                    ?></code></pre>
                    <ol>
                        <li>noticeTable()：你可以自由使用 <a href="https://codeigniter.com/userguide3/database/query_builder.html" target="_blank">Query Builder</a> 的所有方法，滿足你對資料庫查詢的所有需求。最後必須將 Query Builder 宣告為模型的公開屬性，讓 TablesIgniterCI3 可以取用。</li>
