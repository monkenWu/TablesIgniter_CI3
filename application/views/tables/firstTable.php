        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="ex-model-1" role="tabpanel" >
                    ...
                    ?></code></pre>
                    <ol>
                        <li>你可以自由使用 <a href="https://codeigniter.com/userguide3/database/query_builder.html" target="_blank">Query Builder</a> 的所有方法，滿足你對資料庫查詢的所有需求。最後必須將 Query Builder 宣告為模型的公開屬性，讓 TablesIgniterCI3 可以取用。</li>
                    </ol>
                </div>
